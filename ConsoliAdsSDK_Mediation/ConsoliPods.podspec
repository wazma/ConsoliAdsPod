...
Pod::Spec.new do |s|
  s.name             = 'ConsoliPods'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ConsoliPods.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Wazma Ali/ConsoliPods'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Wazma Ali' => 'wazma.ali@consoliads.com' }
  s.source           = { :git => 'https://github.com/Wazma Ali/ConsoliPods.git', :tag => s.version.to_s }
